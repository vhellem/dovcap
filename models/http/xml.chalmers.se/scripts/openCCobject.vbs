...
set model = objView.parent.instance.ownerModel

'set actions = model.findInstances(actionType, "name", "Composition Elements")
set actions = model.findInstances(actionType, "name", "Composition set")
