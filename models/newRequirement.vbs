...
'stop
    if not isEnabled(reqType) then
        MsgBox "This functions requires a constraint to be specified!" & vbCrLf & "No constraint was found!"
    else
        ...
        ccInstanceType.parameterRule = "Parameters(Technology Responsible)"
